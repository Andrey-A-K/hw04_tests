...
SECRET_KEY = '9_&u74j7j0r1(vg8wjw!s7lr+8jnvld20jl4koj3+q(yacsg4s'
...
TEMPLATES_DIR_2 = os.path.join(BASE_DIR, "posts/templates/posts")

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [TEMPLATES_DIR, TEMPLATES_DIR_2],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
